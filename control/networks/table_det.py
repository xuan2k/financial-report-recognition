...
import argparse
from visualize import vis_img, crop_img
import os
...
#     parser.add_argument("--img_dir", default="/workspace/warehouse/refined-data/ACB/rgb",
#                         help="Single input image or image list to predict.")
    
#     parser.add_argument("--save_dir", default="/workspace/warehouse/result/table/ACB",
#                         help="Directory to save inference result.")
    
#     parser.add_argument("--config", default='/workspace/source/Config/cascade_mask_rcnn_hrnetv2p_w32_20e.py',
#                         help="Path to config file.")
    
#     parser.add_argument("--model", default='/workspace/source/pretrained/epoch_14.pth',
...
#             crop_img(img_path, rgb_dir, bbox=bbox)
#         else:
